...
var defaultProgram = {title: "", subtitle: "", description: "", category: "", airdate: "", seriesid: "", programid: "", channum: "", channelname: "", channame: "", starttime: "", endtime: "", starttimeutc: "", endtimeutc: "", hostname: "", recgroup: "", recstartts: "", recstarttsutc: "", filesize: "", recstatus: "100", cardid: "", intid: "", plot: "", releasedate: "", fullEpisode: "", filename: ""};
...
var dateToUtc = function(inDate) {

	//var utcDate = new Date(inDate.getUTCFullYear(), inDate.getUTCMonth(), inDate.getUTCDate(),  inDate.getUTCHours(), inDate.getUTCMinutes(), inDate.getUTCSeconds());
	
	var utcDate = new Date();
	utcDate.setTime(inDate.valueOf() + 60000 * inDate.getTimezoneOffset());
	
	return utcDate;

}

var dateFromUtc = function(inDate) {
